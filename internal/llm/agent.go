...
- File tools (read_file, view_dir, search_grep, diff_file) use paths relative to the current workplace unless the tool explicitly accepts otherwise. Prefer small, reviewable diffs.
